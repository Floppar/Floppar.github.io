const gifts = [    "Ein personleg gavebok",    "Ein opplevelsesgave som fallskjermhopping",    "Eit abonnement på favorittmagasinet",    "Ein fine klokke",    "Ein deilig parfyme",    "Bøker fra favorittforfatteren",    "Ei ny teknologisk gadget",    "Eit gavekort til ein restaurant",    "Ein kosegenser",    "Heimelagde småkaker",    "Eit medlemskap i ein klubb eller forening",    "Eit kunstverk fra ein lokal kunstner",    "Ein reise til ein spennande destinasjon",    "Eit sett med kvalitetskaffe eller te"];
